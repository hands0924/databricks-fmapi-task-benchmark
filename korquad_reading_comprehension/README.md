# korquad_reading_comprehension

Korean ML-engineering task. Metric: **char-F1** (higher is better). Full spec in [`TASK_DESCRIPTION.md`](./TASK_DESCRIPTION.md); standardized prompt in [`PROMPT.md`](./PROMPT.md).

## Results — Opus 5 vs GPT-5.6-sol vs GLM 5.2

3 models, one fixed harness (ucode → Databricks AI Gateway), model swapped.

| Model | 결과물 퀄리티 (char-F1) | 소요시간 | LLM 비용 |
|---|---|---|---|
| Opus 5 | **0.4691** | 54 min | $23.22 |
| GPT-5.6-sol | 0.412 | 35 min | $5.17 |
| GLM 5.2 | DNF | 88 min | $3.10 |
